...
public class RedisAuthListenerImpl implements AuthListener {
    ...
    public RedisAuthListenerImpl(@Qualifier("configRedisTemplate") RedisTemplate<String,Object> redisTemplate) {
     ...
     * **/
    @Override
    @RabbitListener(queues = RabbitMqKeys.AUTH_QUEUE_REDIS)
    public void smsSender(Channel channel, Message message){
        try {
